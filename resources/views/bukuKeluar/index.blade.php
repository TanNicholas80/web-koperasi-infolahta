            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Buku Besar Kas Keluar</h5>
                        </div>
                        <form action="{{ route('buku-keluar.export') }}" method="GET" class="d-flex align-items-center">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        @include('bukuKeluar.table_buku_keluar', [$kasInduk, $bukuKeluar, $totals])
                    </div>
                    <div class="d-flex justify-content-center mt-4">
                        <form action="{{ route('buku-keluar') }}" method="GET" class="d-flex align-items-center">
                            @php
