    ...
    <div class="container">
        ...
        <form action="{{ route('kasUsipa.update', $kasUsipa->id) }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="date" id="date" name="date_usipa" class="form-control" value="{{ $kasUsipa->date_usipa }}" required>
            </div>
            ...
            @foreach ($kasUsipa->transactions as $index => $transaction)
                <fieldset>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="transactions[{{ $index }}][jenis_transaksi_usipa]" class="form-control"
                            value="{{ $transaction->jenis_transaksi_usipa }}" required>
                    </div>
                    ...
                    <div class="kas-masuk-fields" style="display: none;">
                        <div class="form-group mb-3">
                            ...
                            <select name="transactions[{{ $index }}][kategori_buku_besar_usipa]" class="form-control">
                                @php
                                    $kasMasukOptions = [
                                        'bank_sp' => 'BANK S/P',
                                ...
                                @endphp
                                <option value="{{ $transaction->kategori_buku_besar_usipa }}">Current Kategori Buku Besar KM
                                </option>
                    ...
                    <div class="kas-keluar-fields" style="display: none;">
                        <div class="form-group mb-3">
                            ...
                            <select name="transactions[{{ $index }}][kategori_buku_besar_usipa]" class="form-control">
                                ...
                                @endphp
                                <option value="{{ $transaction->kategori_buku_besar_usipa }}">Current Kategori Buku Besar KK
                                </option>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleFieldsByStatus(statusField) {
                ...
                const kasKeluarSelect = kasKeluarFields.querySelector('select[name$="[kategori_buku_besar_usipa]"]');
                ...
                if (status === 'KM') {
                    ...
                    kasMasukSelect.setAttribute('name',
                        `transactions[${parentFieldset.dataset.index}][kategori_buku_besar_usipa]`
