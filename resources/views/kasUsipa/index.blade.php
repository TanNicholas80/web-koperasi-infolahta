                                            ...
                                            @foreach ($kas->transactions as $transaksi)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">
                                                            {{ $transaksi->status_usipa }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">
                                                            {{ $transaksi->periode_usipa }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">
                                                            {{ $transaksi->kategori_buku_besar_usipa }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0 debet-transaction">
                                                            {{ $transaksi->debet_transaction_usipa }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0 kredit-transaction">
                                                            {{ $transaksi->kredit_transaction_usipa }}</p>
                                                    </td>
                                                    <td class="text-center">
