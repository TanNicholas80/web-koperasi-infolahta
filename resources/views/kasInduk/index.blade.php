                ...
                <div class="card-header pb-0">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0">{{ $transaksi->status }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0">{{ $transaksi->periode }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0">
                                                {{ $transaksi->kategori_buku_besar }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0 debet-transaction">
                                                {{ $transaksi->debet_transaction }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0 kredit-transaction">
                                                {{ $transaksi->kredit_transaction }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0 saldo">{{ $kas->saldo }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <a href="{{ route('kasInduk.edit', $kas->id) }}" class="mx-3"
                                                data-bs-toggle="tooltip"
                                                data-bs-original-title="Edit Kas Induk">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <form action="{{ route('kasInduk.index') }}" method="GET" class="d-flex align-items-center">
                                @php
