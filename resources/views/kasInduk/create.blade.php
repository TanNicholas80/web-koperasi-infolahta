            ...
            <div id="transactions-container">
                ...
                <div class="transaction-group">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="transactions[0][periode]" class="form-control" required>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateTransactionFields(transactionGroup) {
                ...
                // Add 'rupiah' class to credit and debit fields
                transactionGroup.querySelectorAll('input.kredit, input.debet').forEach(input => {
                    input.classList.add('rupiah');
                });
            }
            ...
            // Attach rupiah formatting listeners to all existing fields on page load
            attachRupiahListeners();

            // Re-attach listeners after adding a new transaction
            transactionsContainer.addEventListener('click', function(event) {
                if (event.target && event.target.matches('.add-transaction')) {
                    setTimeout(attachRupiahListeners, 100); // Delay to ensure new inputs are ready
                }
            });
        });
