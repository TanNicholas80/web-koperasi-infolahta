            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Kas Keluar Usipa</h5>
                        </div>
                        <form action="{{ route('kas-keluar-usipa.export') }}" method="GET" class="d-flex align-items-center">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        @include('kasKeluarUsipa.table_kas_keluar_usipa', [$kasUsipa, $totalKredit])
                    </div>
                    <div class="d-flex justify-content-center mt-4">
                        <form action="{{ route('kas-keluar-usipa') }}" method="GET" class="d-flex align-items-center">
                            @php
