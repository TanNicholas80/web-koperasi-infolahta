...
class KasMasukUsipaPerMothSheet implements FromView, WithTitle, WithColumnWidths, WithStyles
{
    protected $year;
    protected $month;
    ...
    public function view(): View
    {
        ...
        $totalDebet = KasUsipaTrans::whereYear('trans_date_usipa', $this->year)
